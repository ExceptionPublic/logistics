...
<head>
    ...
    <title>Title</title>
    <script type="text/javascript" src="/js/basicJs/goods/GoodsAdd.js"></script>
</head>
<body>
<form method="post" lay-event="goodsAdd" id="goodsAdd" class="layui-form">
    ...
    <div class="layui-container layui-form" style="margin-top: 10px;">
        <div class="layui-row">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block" >
                        <select name="goodstypeuuid"
                                lay-verify="required"
                                id="goodstypeuuid" style="width: 40px;">
                            <option value=""></option>
                        </select>
                    </div>
                </div>
            ...
            <div class="layui-form-item">
                <div class="layui-input-block">
                    <button class="layui-btn" lay-submit lay-filter="btn_goodsAdd">立即提交</button>
